...
app.controller('updateCtrl', ['$scope', '$resource', '$location', '$routeParams', function($scope, $resource, $location, $routeParams){
	var collection = $resource("/api/person/:id", {id: "@_id"}, {update: {method: "PUT"}});
...
app.controller('deleteCtrl', ['$scope', '$resource', '$location', '$routeParams', function($scope, $resource, $location, $routeParams){
